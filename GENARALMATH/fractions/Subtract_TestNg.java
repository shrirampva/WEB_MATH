...
public class Subtract_TestNg {
	...
	public void ValidationApp() throws Throwable, Exception {						
		...
		Thread.sleep(3000);	
		WebElement add = driver.findElement(By.xpath("//a[normalize-space()='Subtract']"));	
		...
		Thread.sleep(3000);
		WebElement addit = driver.findElement(By.xpath("//input[@value='Subtract']"));
		addit.click();
		Thread.sleep(10000);	
