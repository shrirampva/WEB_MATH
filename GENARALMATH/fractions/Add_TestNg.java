...
public class Add_TestNg {
	...
	public void ValidationApp() throws Throwable, Exception {						
		...
		Thread.sleep(3000);
		WebElement addit = driver.findElement(By.xpath("//input[@value='Add']"));
		addit.click();
		Thread.sleep(10000);	
		File f1 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);											
		Files.copy(f1, new File("D:\\ECLIPS\\HDFC\\Automation\\WEB_MATH\\ScreenShots\\Addit.png"));
